package cn.edu.ncepu.crypto.algebra;
...
public abstract class Engine {
	...
	public Engine(String schemeName, ProveSecModel proveSecModel, PayloadSecLevel payloadSecLevel,
	...
	public PredicateSecLevel getPredicateSecLevel() {
		return this.predicate_security_level;
	}
}
