...
public class RBACLLW15Engine extends Engine {
	...
	public PairingKeySerParameter ACGenP(PairingKeySerParameter publicKey, PairingKeySerParameter masterKey,
		...
		secretKeyGenerator.init(new RBACLLW15AccessCredentialPGenParameter(publicKey, masterKey, id));
	...
	public PairingKeySerParameter ACGenP(PairingKeySerParameter publicKey, PairingKeySerParameter masterKey,
		...
		RBACLLW15AccessCredentialPGenerator secretKeyGenerator = new RBACLLW15AccessCredentialPGenerator();
		secretKeyGenerator
				.init(new RBACLLW15AccessCredentialPGenParameter(publicKey, masterKey, intermediateParameters, id));
	...
	public PairingKeySerParameter ACGenM(PairingKeySerParameter publicKey, PairingKeySerParameter masterKey,
		...
		secretKeyGenerator.init(new RBACLLW15AccessCredentialMGenParameter(publicKey, masterKey, roles, time));
	...
	public PairingKeySerParameter ACGenM(PairingKeySerParameter publicKey, PairingKeySerParameter masterKey,
		...
		secretKeyGenerator.init(
				new RBACLLW15AccessCredentialMGenParameter(publicKey, masterKey, intermediateParameters, roles, time));
	...
	public PairingKeySerParameter ACDeleM(PairingKeySerParameter publicKey, PairingKeySerParameter accessCredentialM,
		...
		RBACLLW15AccessCredentialMGenerator secretKeyGenerator = new RBACLLW15AccessCredentialMGenerator();
		secretKeyGenerator.init(new RBACLLW15AccessCredentialMDeleParameter(publicKey, accessCredentialM, index, role));
	...
	public PairingKeySerParameter ACDeleM(PairingKeySerParameter publicKey, PairingKeySerParameter accessCredentialM,
		...
		isValidACDeleMParameters(publicKey, accessCredentialM);
		RBACLLW15AccessCredentialMGenerator secretKeyGenerator = new RBACLLW15AccessCredentialMGenerator();
		secretKeyGenerator.init(new RBACLLW15AccessCredentialMDeleParameter(publicKey, accessCredentialM,
				intermediateParameters, index, role));
	...
	private void isValidACDeleMParameters(PairingKeySerParameter publicKey, PairingKeySerParameter accessCredentialM) {
		...
		if (!(accessCredentialM instanceof RBACLLW15AccessCredentialMSerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, accessCredentialM,
	 ...
	 */
	public PairingKeyEncapsulationSerPair EHREnc(PairingKeySerParameter publicKey, String id, String[] roles,
			String time) {
		...
		keyEncapsulationPairGenerator.init(new RBACLLW15EncapsulationGenParameter(publicKey, id, roles, time));
	 ...
	 */
	public PairingKeyEncapsulationSerPair EHREnc(PairingKeySerParameter publicKey,
			PairingCipherSerParameter intermediateParameters, String id, String[] roles, String time) {
		isValidKeyEncapsulationParameters(publicKey);
		RBACLLW15EncapsulationPairGenerator keyEncapsulationPairGenerator = new RBACLLW15EncapsulationPairGenerator();
		keyEncapsulationPairGenerator
				.init(new RBACLLW15EncapsulationGenParameter(publicKey, intermediateParameters, id, roles, time));
	 ...
	 */
	public boolean EHRAudit(PairingKeySerParameter publicKey, String id, String[] roles, String time,
			PairingCipherSerParameter encapsulation) {
		if (!(publicKey instanceof RBACLLW15PublicKeySerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, publicKey,
					RBACLLW15PublicKeySerParameter.class.getName());
		}
		if (!(encapsulation instanceof RBACLLW15EncapsulationSerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, encapsulation,
		...
		encapsulationAudit.init(new RBACLLW15EncapsulationAuditParameter(publicKey, id, roles, time, encapsulation));
	 ...
	 */
	public byte[] EHRDecM(PairingKeySerParameter publicKey, String id, String[] roles, String time,
			PairingCipherSerParameter encapsulation, PairingKeySerParameter accessCredentialM)
		...
		keyDecapsulationGenerator.init(
				new RBACLLW15DecapsulationMParameter(publicKey, accessCredentialM, id, roles, time, encapsulation));
	 ...
	 */
	public byte[] EHRDecMWithAudit(PairingKeySerParameter publicKey, String id, String[] roles, String time,
			PairingCipherSerParameter encapsulation, PairingKeySerParameter accessCredentialM)
			throws InvalidCipherTextException {
		isValidAccessCredentialMDecapsulationParameters(publicKey, encapsulation, accessCredentialM);
	...
	private void isValidAccessCredentialMDecapsulationParameters(PairingKeySerParameter publicKey,
			PairingCipherSerParameter encapsulation, PairingKeySerParameter accessCredentialM) {
		if (!(publicKey instanceof RBACLLW15PublicKeySerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, publicKey,
					RBACLLW15PublicKeySerParameter.class.getName());
	 ...
	 * @return decapsulated session key
	 */
	public byte[] EHRDecP(PairingKeySerParameter publicKey, String id, String[] roles, String time,
			PairingCipherSerParameter encapsulation, PairingKeySerParameter accessCredentialP)
			throws InvalidCipherTextException {
		...
		keyDecapsulationGenerator.init(
				new RBACLLW15DecapsulationPParameter(publicKey, accessCredentialP, id, roles, time, encapsulation));
		return keyDecapsulationGenerator.recoverKey();
	}
	 ...
	 * @return decapsulated session key
	 */
	public byte[] EHRDecPWithAudit(PairingKeySerParameter publicKey, String id, String[] roles, String time,
			PairingCipherSerParameter encapsulation, PairingKeySerParameter accessCredentialP)
			throws InvalidCipherTextException {
		isValidAccessCredentialPDecapsulationParameters(publicKey, encapsulation, accessCredentialP);
		if (!EHRAudit(publicKey, id, roles, time, encapsulation)) {
	...
	private void isValidAccessCredentialPDecapsulationParameters(PairingKeySerParameter publicKey,
			PairingCipherSerParameter encapsulation, PairingKeySerParameter accessCredentialP) {
		if (!(publicKey instanceof RBACLLW15PublicKeySerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, publicKey,
					RBACLLW15PublicKeySerParameter.class.getName());
		...
		if (!(accessCredentialP instanceof RBACLLW15AccessCredentialPSerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, accessCredentialP,
