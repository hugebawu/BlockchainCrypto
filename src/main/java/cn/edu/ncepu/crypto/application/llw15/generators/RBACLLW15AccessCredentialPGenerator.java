...
public class RBACLLW15AccessCredentialPGenerator implements PairingKeyParameterGenerator {
	...
	public PairingKeySerParameter generateKey() {
		...
		if (!parameters.isIntermediateGeneration()) {
			...
			return new RBACLLW15AccessCredentialPSerParameter(publicKeyParameters.getParameters(), parameters.getId(),
					elementId, a0, a1, b0, bv, bs);
		} else {
			...
			Element a0 = intermediateParameters.get_G_h_r().powZn(elementId).mul(intermediateParameters.get_G_3_r())
