package cn.edu.ncepu.crypto.application.llw15.serparams;
...
public class RBACLLW15AccessCredentialMSerParameter extends PairingKeySerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 871733202091281232L;
	...
	public RBACLLW15AccessCredentialMSerParameter(PairingParameters pairingParameters, String[] roles,
			Element[] elementRoles, String time, Element elementTime, Element a0, Element a1, Element a2, Element bv,
			Element[] bs) {
	...
	private void readObject(java.io.ObjectInputStream objectInputStream)
		...
		this.elementRoles = PairingUtils.GetElementArrayFromBytes(pairing, this.byteArraysElementRoles,
		...
		this.bs = PairingUtils.GetElementArrayFromBytes(pairing, this.byteArraysElementBs,
