package cn.edu.ncepu.crypto.encryption.abe.cpabe.bsw07.generators;
...
public class CPABEBSW07DecryptionGenerator implements PairingDecryptionGenerator, PairingDecapsulationGenerator {
	...
	private void computeDecapsulation() throws InvalidCipherTextException {
		CPABEBSW07PublicKeySerParameter publicKeyParameter = (CPABEBSW07PublicKeySerParameter) this.parameter
				.getPublicKeyParameter();
		CPABEBSW07SecretKeySerParameter secretKeyParameter = (CPABEBSW07SecretKeySerParameter) this.parameter
				.getSecretKeyParameter();
		CPABEBSW07HeaderSerParameter ciphertextParameter = (CPABEBSW07HeaderSerParameter) this.parameter
		...
		try {
			...
			this.sessionKey = pairing.pairing(ciphertextParameter.getC(), secretKeyParameter.getD()).div(A)
					.getImmutable();
	...
	public Element recoverMessage() throws InvalidCipherTextException {
		...
		CPABEBSW07CiphertextSerParameter ciphertextParameter = (CPABEBSW07CiphertextSerParameter) this.parameter
				.getCiphertextParameter();
