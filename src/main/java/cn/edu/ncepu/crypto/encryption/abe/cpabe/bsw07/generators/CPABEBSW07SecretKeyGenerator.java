...
public class CPABEBSW07SecretKeyGenerator implements PairingKeyParameterGenerator {
	...
	public PairingKeySerParameter generateKey() {
		CPABEBSW07MasterSecretKeySerParameter masterSecretKeyParameter = (CPABEBSW07MasterSecretKeySerParameter) parameter
				.getMasterSecretKeyParameter();
		CPABEBSW07PublicKeySerParameter publicKeyParameter = (CPABEBSW07PublicKeySerParameter) parameter
		...
		Element D = masterSecretKeyParameter.getGAlpha().mul(publicKeyParameter.getG().powZn(r))
				.powZn(masterSecretKeyParameter.getBeta().invert()).getImmutable();
