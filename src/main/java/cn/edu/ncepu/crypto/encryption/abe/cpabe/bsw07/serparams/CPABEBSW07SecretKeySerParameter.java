package cn.edu.ncepu.crypto.encryption.abe.cpabe.bsw07.serparams;
...
public class CPABEBSW07SecretKeySerParameter extends PairingKeySerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5973249200064430732L;
	...
	public CPABEBSW07SecretKeySerParameter(PairingParameters pairingParameters, Element D, Map<String, Element> D1s,
			Map<String, Element> D2s) {
	...
	private void readObject(java.io.ObjectInputStream objectInputStream)
		...
		for (String attribute : this.byteArraysD1s.keySet()) {
			this.D1s.put(attribute,
					pairing.getG1().newElementFromBytes(this.byteArraysD1s.get(attribute)).getImmutable());
			this.D2s.put(attribute,
					pairing.getG1().newElementFromBytes(this.byteArraysD2s.get(attribute)).getImmutable());
		}
	}
}