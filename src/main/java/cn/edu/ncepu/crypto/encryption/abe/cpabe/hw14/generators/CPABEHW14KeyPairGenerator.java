...
public class CPABEHW14KeyPairGenerator extends CPABERW13KeyPairGenerator {
	public PairingKeySerPair generateKeyPair() {
		...
		CPABERW13MasterSecretKeySerParameter oriMasterSecretKeyParameter = (CPABERW13MasterSecretKeySerParameter) keyPair
				.getPrivate();
		CPABEHW14PublicKeySerParameter publicKeyParameter = new CPABEHW14PublicKeySerParameter(
				...
				oriPublicKeyParameter.getH(), oriPublicKeyParameter.getW(), oriPublicKeyParameter.getV(),
