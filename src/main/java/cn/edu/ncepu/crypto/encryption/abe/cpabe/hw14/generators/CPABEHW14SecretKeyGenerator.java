...
public class CPABEHW14SecretKeyGenerator extends CPABERW13SecretKeyGenerator {
	public PairingKeySerParameter generateKey() {
		...
		return new CPABEHW14SecretKeySerParameter(oriSecretKeyParameter.getParameters(), oriSecretKeyParameter.getK0(),
				oriSecretKeyParameter.getK1(), oriSecretKeyParameter.getK2s(), oriSecretKeyParameter.getK3s());
	}
}
