...
public class CPABEHW14IntermediateSerParameter extends PairingCipherSerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1256166032190904463L;
	...
	public CPABEHW14IntermediateSerParameter(PairingParameters parameters, int n, Element sessionKey, Element s,
			Element C0, Element[] lambdas, Element[] ts, Element[] xs, Element[] C1s, Element[] C2s, Element[] C3s) {
		super(parameters);
		this.n = n;
	...
	private void readObject(java.io.ObjectInputStream objectInputStream)
		...
		this.lambdas = PairingUtils.GetElementArrayFromBytes(pairing, this.byteArraysLambdas,
