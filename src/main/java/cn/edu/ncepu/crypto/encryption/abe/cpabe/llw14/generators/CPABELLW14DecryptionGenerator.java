...
public class CPABELLW14DecryptionGenerator extends CPABERW13DecryptionGenerator {
	...
	public void init(CipherParameters parameter) {
		...
		this.publicKeyParameter = (CPABELLW14PublicKeySerParameter) oriDecryptionGenerationParameter
		...
		CPABEDecryptionGenerationParameter decryptionGenerationParameter = new CPABEDecryptionGenerationParameter(
				...
				oriDecryptionGenerationParameter.getAccessPolicy(), mappedStringRhos,
	...
	public Element recoverMessage() throws InvalidCipherTextException {
		...
		CPABELLW14CiphertextSerParameter ciphertextParameter = (CPABELLW14CiphertextSerParameter) this.parameter
