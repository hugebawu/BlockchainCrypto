...
import cn.edu.ncepu.crypto.encryption.abe.cpabe.llw14.serparams.CPABELLW14CiphertextSerParameter;
...
public class CPABELLW14EncryptionGenerator extends CPABERW13EncryptionGenerator {
	...
	public PairingKeyEncapsulationSerPair generateEncryptionPair() {
		...
		return new PairingKeyEncapsulationSerPair(this.sessionKey.toBytes(), new CPABELLW14HeaderSerParameter(
				publicKeyParameter.getParameters(), chameleonHash, r, C01, C02, C03, C0, C1s, C2s, C3s));
	}

	public PairingCipherSerParameter generateCiphertext() {
		computeEncapsulation();
		Element C = this.sessionKey.mul(this.parameter.getMessage()).getImmutable();
		return new CPABELLW14CiphertextSerParameter(publicKeyParameter.getParameters(), chameleonHash, r, C01, C02, C03,
				C, C0, C1s, C2s, C3s);
	}
}
