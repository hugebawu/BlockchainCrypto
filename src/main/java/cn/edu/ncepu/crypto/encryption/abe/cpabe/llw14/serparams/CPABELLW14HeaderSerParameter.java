...
public class CPABELLW14HeaderSerParameter extends CPABERW13HeaderSerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4086559886192498688L;
	...
	public CPABELLW14HeaderSerParameter(PairingParameters pairingParameters, byte[] chameleonHash, byte[] r,
			Element C01, Element C02, Element C03, Element C0, Map<String, Element> C1s, Map<String, Element> C2s,
			Map<String, Element> C3s) {
