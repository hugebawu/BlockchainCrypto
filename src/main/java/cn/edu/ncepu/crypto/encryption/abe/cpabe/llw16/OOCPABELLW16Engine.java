...
public class OOCPABELLW16Engine extends OOCPABEEngine {
	...
	public PairingKeySerParameter keyGen(PairingKeySerParameter publicKey, PairingKeySerParameter masterKey,
		...
		if (!(publicKey instanceof CPABELLW16PublicKeySerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, publicKey,
					CPABELLW16PublicKeySerParameter.class.getName());
		}
		if (!(masterKey instanceof CPABELLW16MasterSecretKeySerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, masterKey,
					CPABELLW16MasterSecretKeySerParameter.class.getName());
		}
	...
	public Element decryption(PairingKeySerParameter publicKey, PairingKeySerParameter secretKey,
		...
		if (!(secretKey instanceof CPABELLW16SecretKeySerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, secretKey,
					CPABELLW16SecretKeySerParameter.class.getName());
		}
		if (!(ciphertext instanceof CPABELLW16CiphertextSerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, ciphertext,
					CPABELLW16CiphertextSerParameter.class.getName());
		}
	...
	public byte[] decapsulation(PairingKeySerParameter publicKey, PairingKeySerParameter secretKey,
		...
		if (!(header instanceof CPABELLW16HeaderSerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, header,
					CPABELLW16HeaderSerParameter.class.getName());
		}
		CPABELLW16DecryptionGenerator decryptionGenerator = new CPABELLW16DecryptionGenerator();
		CPABEDecryptionGenerationParameter decryptionGenerationParameter = new CPABEDecryptionGenerationParameter(
	...
	public PairingCipherSerParameter offlineEncryption(PairingKeySerParameter publicKey, int n) {
		...
		CPABEIntermediateGenerationParameter intermediateGenerationParameter = new CPABEIntermediateGenerationParameter(
				publicKey, n);
	...
	public PairingKeyEncapsulationSerPair encapsulation(PairingKeySerParameter publicKey,
		...
		if (!(intermediate instanceof CPABELLW16IntermediateSerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, intermediate,
					CPABELLW16IntermediateSerParameter.class.getName());
		}
		CPABELLW16EncryptionGenerator encryptionGenerator = new CPABELLW16EncryptionGenerator();
		CPABEEncryptionGenerationParameter encryptionGenerationParameter = new CPABEEncryptionGenerationParameter(
				accessControlEngine, publicKey, accessPolicyIntArrays, rhos, null);
