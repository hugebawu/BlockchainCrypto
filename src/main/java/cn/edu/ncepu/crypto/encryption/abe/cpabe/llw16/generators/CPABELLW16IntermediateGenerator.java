...
public class CPABELLW16IntermediateGenerator extends CPABEHW14IntermediateGenerator {
	...
	public PairingCipherSerParameter generateCiphertext() {
		...
		return new CPABELLW16IntermediateSerParameter(publicKeyParameter.getParameters(), n, chameleonHash, r,
				chameleonHashPublicKey, chameleonHashSecretKey, C01, C02, C03, sessionKey, s, C0, lambdas, ts, xs, C1s,
				C2s, C3s);
	}
}
