...
public class CPABELLW16KeyPairGenerator extends CPABEHW14KeyPairGenerator {
	public PairingKeySerPair generateKeyPair() {
		...
		CPABEHW14PublicKeySerParameter publicKeyRW13Parameter = (CPABEHW14PublicKeySerParameter) pairingKeySerPair
				.getPublic();
		CPABEHW14MasterSecretKeySerParameter masterKeyRW13Parameter = (CPABEHW14MasterSecretKeySerParameter) pairingKeySerPair
				.getPrivate();
		...
		CPABELLW16PublicKeySerParameter publicKeyParameter = new CPABELLW16PublicKeySerParameter(
				...
				publicKeyRW13Parameter.getH(), publicKeyRW13Parameter.getW(), publicKeyRW13Parameter.getV(),
