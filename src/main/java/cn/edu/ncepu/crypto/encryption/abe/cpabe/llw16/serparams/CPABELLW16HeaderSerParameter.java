...
public class CPABELLW16HeaderSerParameter extends CPABEHW14HeaderSerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 92537475071954684L;
	...
	public CPABELLW16HeaderSerParameter(PairingParameters pairingParameters, byte[] chameleonHash, byte[] r,
			AsymmetricKeySerParameter chameleonHashPublicKey, Element C01, Element C02, Element C03, Element C0,
			Map<String, Element> C1s, Map<String, Element> C2s, Map<String, Element> C3s, Map<String, Element> C4s,
			Map<String, Element> C5s) {
