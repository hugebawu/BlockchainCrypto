...
public class CPABELLW16IntermediateSerParameter extends CPABEHW14IntermediateSerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3314570632675244062L;
	...
	public CPABELLW16IntermediateSerParameter(PairingParameters parameters, int n, byte[] chameleonHash, byte[] r,
			AsymmetricKeySerParameter chameleonHashPublicKey, AsymmetricKeySerParameter chameleonHashSecretKey,
			Element C01, Element C02, Element C03, Element sessionKey, Element s, Element C0, Element[] lambdas,
			Element[] ts, Element[] xs, Element[] C1s, Element[] C2s, Element[] C3s) {
