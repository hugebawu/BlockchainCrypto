...
public class CPABERW13SecretKeySerParameter extends PairingKeySerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8224657435282026873L;
	...
	private void readObject(java.io.ObjectInputStream objectInputStream)
		...
		for (String attribute : this.byteArraysK2s.keySet()) {
			this.K2s.put(attribute,
					pairing.getG1().newElementFromBytes(this.byteArraysK2s.get(attribute)).getImmutable());
			this.K3s.put(attribute,
					pairing.getG1().newElementFromBytes(this.byteArraysK3s.get(attribute)).getImmutable());
		}
	}
}