...
public class KPABEGPSW06aMasterSecretKeySerParameter extends PairingKeySerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7976708939494417291L;
	...
	public KPABEGPSW06aMasterSecretKeySerParameter(PairingParameters pairingParameters, Map<String, Element> ts,
			Element y) {
	...
	private void readObject(java.io.ObjectInputStream objectInputStream)
		...
		for (String attribute : this.byteArraysTs.keySet()) {
			this.ts.put(attribute,
					pairing.getZr().newElementFromBytes(this.byteArraysTs.get(attribute)).getImmutable());
		}
