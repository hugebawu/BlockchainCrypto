package cn.edu.ncepu.crypto.encryption.abe.kpabe.gpsw06b.generators;
...
public class KPABEGPSW06bDecryptionGenerator implements PairingDecryptionGenerator, PairingDecapsulationGenerator {
	...
	private void computeDecapsulation() throws InvalidCipherTextException {
		KPABEGPSW06bPublicKeySerParameter publicKeyParameter = (KPABEGPSW06bPublicKeySerParameter) this.params
				.getPublicKeyParameter();
		KPABEGPSW06bSecretKeySerParameter secretKeyParameter = (KPABEGPSW06bSecretKeySerParameter) this.params
				.getSecretKeyParameter();
		KPABEGPSW06bHeaderSerParameter ciphertextParameter = (KPABEGPSW06bHeaderSerParameter) this.params
		...
		try {
			...
			for (String attribute : omegaElementsMap.keySet()) {
				...
				sessionKey = sessionKey
						.mul(pairing.pairing(D, ciphertextParameter.getE2()).div(pairing.pairing(R, E)).powZn(lambda))
						.getImmutable();
			}
	...
	public Element recoverMessage() throws InvalidCipherTextException {
		...
		KPABEGPSW06bCiphertextSerParameter ciphertextParameter = (KPABEGPSW06bCiphertextSerParameter) this.params
				.getCiphertextParameter();
