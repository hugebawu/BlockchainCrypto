...
public class KPABEHW14KeyPairGenerator extends KPABERW13KeyPairGenerator {
	public PairingKeySerPair generateKeyPair() {
		...
		KPABERW13MasterSecretKeySerParameter oriMasterSecretKeyParameter = (KPABERW13MasterSecretKeySerParameter) keyPair
				.getPrivate();
		KPABEHW14PublicKeySerParameter publicKeyParameter = new KPABEHW14PublicKeySerParameter(
				oriPublicKeyParameter.getParameters(), oriPublicKeyParameter.getG(), oriPublicKeyParameter.getU(),
				oriPublicKeyParameter.getH(), oriPublicKeyParameter.getW(), oriPublicKeyParameter.getEggAlpha());
