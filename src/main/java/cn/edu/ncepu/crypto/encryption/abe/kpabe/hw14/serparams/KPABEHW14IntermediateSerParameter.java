...
public class KPABEHW14IntermediateSerParameter extends PairingCipherSerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4276538624817590762L;
	...
	public KPABEHW14IntermediateSerParameter(PairingParameters parameters, int n, Element sessionKey, Element s,
			Element C0, Element[] rs, Element[] xs, Element[] C1s, Element[] C2s) {
		super(parameters);
		this.n = n;
