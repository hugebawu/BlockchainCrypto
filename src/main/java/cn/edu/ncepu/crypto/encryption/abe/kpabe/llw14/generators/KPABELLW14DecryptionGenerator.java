...
public class KPABELLW14DecryptionGenerator extends KPABERW13DecryptionGenerator {
	...
	public void init(CipherParameters parameter) {
		...
		this.publicKeyParameter = (KPABELLW14PublicKeySerParameter) oriDecryptionGenerationParameter
		...
		KPABEDecryptionGenerationParameter decryptionGenerationParameter = new KPABEDecryptionGenerationParameter(
				...
				oriDecryptionGenerationParameter.getSecretKeyParameter(), mappedStringAttributes,
	...
	public Element recoverMessage() throws InvalidCipherTextException {
		...
		KPABELLW14CiphertextSerParameter ciphertextParameter = (KPABELLW14CiphertextSerParameter) this.parameter
