...
public class KPABELLW14EncryptionGenerator extends KPABERW13EncryptionGenerator {
	...
	public PairingKeyEncapsulationSerPair generateEncryptionPair() {
		...
		return new PairingKeyEncapsulationSerPair(this.sessionKey.toBytes(), new KPABELLW14HeaderSerParameter(
	...
	public PairingCipherSerParameter generateCiphertext() {
		computeEncapsulation();
		Element C = this.sessionKey.mul(this.parameter.getMessage()).getImmutable();
		return new KPABELLW14CiphertextSerParameter(publicKeyParameter.getParameters(), chameleonHash, r, C01, C02, C,
				C0, C1s, C2s);
	}
}