...
public class KPABELLW14KeyPairGenerator extends KPABERW13KeyPairGenerator {
	public PairingKeySerPair generateKeyPair() {
		...
		KPABERW13PublicKeySerParameter publicKeyRW13Parameter = (KPABERW13PublicKeySerParameter) pairingKeySerPair
				.getPublic();
		KPABERW13MasterSecretKeySerParameter masterKeyRW13Parameter = (KPABERW13MasterSecretKeySerParameter) pairingKeySerPair
				.getPrivate();
