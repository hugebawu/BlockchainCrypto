...
public class KPABELLW14CiphertextSerParameter extends KPABELLW14HeaderSerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3852798072226088426L;
	private transient Element C;
	private final byte[] byteArrayC;

	public KPABELLW14CiphertextSerParameter(PairingParameters pairingParameters, byte[] chameleonHash, byte[] r,
			Element C01, Element C02, Element C, Element C0, Map<String, Element> C1s, Map<String, Element> C2s) {
