...
public class KPABELLW14HeaderSerParameter extends KPABERW13HeaderSerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6431054527390624778L;
	...
	public KPABELLW14HeaderSerParameter(PairingParameters pairingParameters, byte[] chameleonHash, byte[] r,
			Element C01, Element C02, Element C0, Map<String, Element> C1s, Map<String, Element> C2s) {
