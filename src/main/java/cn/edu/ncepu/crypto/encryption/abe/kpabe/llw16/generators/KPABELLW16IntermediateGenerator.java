...
public class KPABELLW16IntermediateGenerator extends KPABEHW14IntermediateGenerator {
	...
	public void init(CipherParameters parameter) {
		...
		AsymmetricKeySerPairGenerator chKeyPairGenerator = oriIntermediateGenParameter
				.getChameleonHashKeyPairGenerator();
		KeyGenerationParameters chKeyPairGenParameter = oriIntermediateGenParameter
		...
		KPABEIntermediateGenerationParameter resultIntermediateGenParameter = new KPABEIntermediateGenerationParameter(
				oriIntermediateGenParameter.getPublicKeyParameter(), oriIntermediateGenParameter.getN());
	...
	public PairingCipherSerParameter generateCiphertext() {
		...
		return new KPABELLW16IntermediateSerParameter(publicKeyParameter.getParameters(), n, chameleonHash, r,
				chameleonHashPublicKey, chameleonHashSecretKey, C01, C02, sessionKey, s, C0, rs, xs, C1s, C2s);
	}
}
