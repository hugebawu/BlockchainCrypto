...
public class KPABELLW16CiphertextSerParameter extends KPABELLW16HeaderSerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8827917426625487110L;
	private transient Element C;
	private final byte[] byteArrayC;

	public KPABELLW16CiphertextSerParameter(PairingParameters pairingParameters, byte[] chameleonHash, byte[] r,
