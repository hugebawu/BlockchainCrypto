...
public class KPABELLW16PublicKeySerParameter extends KPABEHW14PublicKeySerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3768658673355443636L;

	public KPABELLW16PublicKeySerParameter(PairingParameters pairingParameters, Element g, Element u, Element h,
			Element w, Element eggAlpha) {
