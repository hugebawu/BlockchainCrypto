...
public class BEBGW05DecapsulationGenerator implements PairingDecapsulationGenerator {
	...
	public byte[] recoverKey() throws InvalidCipherTextException {
		BEBGW05PublicKeySerParameter publicKeyParameters = (BEBGW05PublicKeySerParameter) this.params
				.getPublicKeyParameter();
		BEBGW05SecretKeySerParameter secretKeyParameters = (BEBGW05SecretKeySerParameter) this.params
				.getSecretKeyParameter();
		BEBGW05HeaderSerParameter ciphertextParameters = (BEBGW05HeaderSerParameter) this.params
		...
		for (int j : indexSet) {
			...
			temp = temp.mul(publicKeyParameters.getGsAt(publicKeyParameters.getMaxUserNum() + 1 - j + i))
					.getImmutable();
		}
