...
public class BEBGW05PublicKeySerParameter extends PairingKeySerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8321160706126158399L;
	...
	public BEBGW05PublicKeySerParameter(PairingParameters pairingParameters, int maxUserNum, Element g, Element[] gs,
			Element v) {
