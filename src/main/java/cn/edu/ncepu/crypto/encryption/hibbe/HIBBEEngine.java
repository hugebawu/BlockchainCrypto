package cn.edu.ncepu.crypto.encryption.hibbe;
...
public abstract class HIBBEEngine extends Engine {
	protected HIBBEEngine(String schemeName, ProveSecModel proveSecModel, PayloadSecLevel payloadSecLevel,
	...
	*/
	public abstract PairingKeySerParameter delegate(PairingKeySerParameter publicKey, PairingKeySerParameter secretKey,
			int index, String id);
