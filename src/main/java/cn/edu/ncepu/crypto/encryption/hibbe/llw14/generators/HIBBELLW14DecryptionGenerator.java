...
public class HIBBELLW14DecryptionGenerator implements PairingDecryptionGenerator, PairingDecapsulationGenerator {
	...
	private void computeDecapsulation() throws InvalidCipherTextException {
		HIBBELLW14PublicKeySerParameter publicKeyParameters = (HIBBELLW14PublicKeySerParameter) this.params
				.getPublicKeyParameter();
		HIBBELLW14SecretKeySerParameter secretKeyParameters = (HIBBELLW14SecretKeySerParameter) this.params
				.getSecretKeyParameter();
		HIBBELLW14HeaderSerParameter ciphertextParameters = (HIBBELLW14HeaderSerParameter) this.params
	...
	public Element recoverMessage() throws InvalidCipherTextException {
		...
		HIBBELLW14CiphertextSerParameter ciphertextParameter = (HIBBELLW14CiphertextSerParameter) this.params
				.getCiphertextParameter();
