...
public class HIBBELLW16aDecryptionGenerator implements PairingDecryptionGenerator, PairingDecapsulationGenerator {
	...
	private void computeDecapsulation() throws InvalidCipherTextException {
		HIBBELLW16aPublicKeySerParameter publicKeyParameters = (HIBBELLW16aPublicKeySerParameter) this.params
				.getPublicKeyParameter();
		HIBBELLW16aSecretKeySerParameter secretKeyParameters = (HIBBELLW16aSecretKeySerParameter) this.params
				.getSecretKeyParameter();
		HIBBELLW16aHeaderSerParameter ciphertextParameters = (HIBBELLW16aHeaderSerParameter) this.params
	...
	public Element recoverMessage() throws InvalidCipherTextException {
		...
		HIBBELLW16aCiphertextSerParameter ciphertextParameter = (HIBBELLW16aCiphertextSerParameter) this.params
				.getCiphertextParameter();
