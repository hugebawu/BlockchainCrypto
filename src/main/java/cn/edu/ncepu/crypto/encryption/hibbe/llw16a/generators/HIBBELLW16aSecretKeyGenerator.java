package cn.edu.ncepu.crypto.encryption.hibbe.llw16a.generators;
...
public class HIBBELLW16aSecretKeyGenerator implements PairingKeyParameterGenerator {
	...
	public PairingKeySerParameter generateKey() {
		if (params instanceof HIBBESecretKeyGenerationParameter) {
			...
			HIBBELLW16aPublicKeySerParameter publicKeyParameters = (HIBBELLW16aPublicKeySerParameter) parameters
					.getPublicKeyParameter();
			HIBBELLW16aMasterSecretKeySerParameter masterSecretKeyParameters = (HIBBELLW16aMasterSecretKeySerParameter) parameters
			...
			return new HIBBELLW16aSecretKeySerParameter(publicKeyParameters.getParameters(), parameters.getIds(),
					elementIds, a0, a1, bs);
			...
			HIBBELLW16aPublicKeySerParameter publicKeyParameters = (HIBBELLW16aPublicKeySerParameter) parameters
					.getPublicKeyParameter();
			HIBBELLW16aSecretKeySerParameter secretKeyParameters = (HIBBELLW16aSecretKeySerParameter) parameters
			...
			for (int i = 0; i < publicKeyParameters.getMaxUser(); i++) {
				if (secretKeyParameters.getIdAt(i) != null) {
					...
					bs[i] = secretKeyParameters.getBsAt(i).mul(publicKeyParameters.getUsAt(i).powZn(t)).getImmutable();
				}
			}
			...
			return new HIBBELLW16aSecretKeySerParameter(publicKeyParameters.getParameters(), ids, elementIds, a0, a1,
					bs);
		} else {
