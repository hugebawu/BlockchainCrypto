...
public class HIBBELLW16bDecryptionGenerator implements PairingDecryptionGenerator, PairingDecapsulationGenerator {
	...
	private void verifyCiphertext() throws InvalidCipherTextException {
		HIBBELLW16bHeaderSerParameter headerParameter = (HIBBELLW16bHeaderSerParameter) this.params
	...
	private void computeDecapsulation() throws InvalidCipherTextException {
		HIBBELLW16bPublicKeySerParameter publicKeyParameters = (HIBBELLW16bPublicKeySerParameter) this.params
				.getPublicKeyParameter();
		HIBBELLW16bSecretKeySerParameter secretKeyParameters = (HIBBELLW16bSecretKeySerParameter) this.params
				.getSecretKeyParameter();
		HIBBELLW16bHeaderSerParameter ciphertextParameters = (HIBBELLW16bHeaderSerParameter) this.params
				.getCiphertextParameter();
		...
		Element[] elementIdsCT = PairingUtils.MapStringArrayToGroup(pairing, this.params.getIds(),
		...
		try {
			...
			Element elementVk = PairingUtils.MapByteArrayToGroup(pairing, byteArraySignPublicKey,
					PairingUtils.PairingGroupType.Zr);
	...
	public Element recoverMessage() throws InvalidCipherTextException {
		...
		HIBBELLW16bCiphertextSerParameter ciphertextParameter = (HIBBELLW16bCiphertextSerParameter) this.params
				.getCiphertextParameter();
