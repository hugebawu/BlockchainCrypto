...
public class HIBBELLW16bSecretKeyGenerator implements PairingKeyParameterGenerator {
	...
	public PairingKeySerParameter generateKey() {
		if (params instanceof HIBBESecretKeyGenerationParameter) {
			...
			HIBBELLW16bPublicKeySerParameter publicKeyParameters = (HIBBELLW16bPublicKeySerParameter) parameters
					.getPublicKeyParameter();
			HIBBELLW16bMasterSecretKeySerParameter masterSecretKeyParameters = (HIBBELLW16bMasterSecretKeySerParameter) parameters
			...
			return new HIBBELLW16bSecretKeySerParameter(publicKeyParameters.getParameters(), parameters.getIds(),
			...
			HIBBELLW16bPublicKeySerParameter publicKeyParameters = (HIBBELLW16bPublicKeySerParameter) parameters
					.getPublicKeyParameter();
			HIBBELLW16bSecretKeySerParameter secretKeyParameters = (HIBBELLW16bSecretKeySerParameter) parameters
			...
			return new HIBBELLW16bSecretKeySerParameter(publicKeyParameters.getParameters(), ids, elementIds, a0, a1,
					bs, bv);
		} else {
