...
public class HIBBELLW16bPublicKeySerParameter extends HIBBELLW16aPublicKeySerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4173948881510884372L;
	private transient Element uv;
	private final byte[] byteArrayUv;

	public HIBBELLW16bPublicKeySerParameter(PairingParameters parameters, Element g, Element g1, Element g2, Element g3,
			Element[] us, Element uv) {
