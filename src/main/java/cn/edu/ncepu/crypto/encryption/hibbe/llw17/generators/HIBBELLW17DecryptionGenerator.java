...
public class HIBBELLW17DecryptionGenerator implements PairingDecryptionGenerator, PairingDecapsulationGenerator {
	...
	private void verifyCiphertext() throws InvalidCipherTextException {
		...
		digest.reset();
		HIBBELLW17PublicKeySerParameter publicKeyParameter = (HIBBELLW17PublicKeySerParameter) this.params
				.getPublicKeyParameter();
		HIBBELLW17HeaderSerParameter headerParameter = (HIBBELLW17HeaderSerParameter) this.params
				.getCiphertextParameter();
		Pairing pairing = PairingFactory.getPairing(publicKeyParameter.getParameters());
		this.elementIdsCT = PairingUtils.MapStringArrayToGroup(pairing, this.params.getIds(),
		...
		this.elementIDv = PairingUtils.MapByteArrayToGroup(pairing, byteArrayIDv, PairingUtils.PairingGroupType.Zr)
				.getImmutable();
	...
	private void computeDecapsulation() throws InvalidCipherTextException {
		HIBBELLW17PublicKeySerParameter publicKeyParameters = (HIBBELLW17PublicKeySerParameter) this.params
				.getPublicKeyParameter();
		HIBBELLW17SecretKeySerParameter secretKeyParameters = (HIBBELLW17SecretKeySerParameter) this.params
				.getSecretKeyParameter();
		HIBBELLW17HeaderSerParameter ciphertextParameters = (HIBBELLW17HeaderSerParameter) this.params
				.getCiphertextParameter();
		...
		for (int i = 0; i < publicKeyParameters.getMaxUser(); i++) {
			if (secretKeyParameters.getIdAt(i) != null
				...
				throw new InvalidCipherTextException(
						"Secret Key identity vector does not match Ciphertext identity vector set");
			}
		}
	...
	public Element recoverMessage() throws InvalidCipherTextException {
		...
		HIBBELLW17CiphertextSerParameter ciphertextParameter = (HIBBELLW17CiphertextSerParameter) this.params
				.getCiphertextParameter();
