...
public class HIBBELLW17PublicKeySerParameter extends HIBBELLW14PublicKeySerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8141218573758949827L;
	private transient Element uv;
	private final byte[] byteArrayUv;

	public HIBBELLW17PublicKeySerParameter(PairingParameters parameters, Element g, Element h, Element[] u, Element uv,
			Element X3, Element eggAlpha) {
	...
	public boolean equals(Object anObject) {
		...
		if (anObject instanceof HIBBELLW17PublicKeySerParameter) {
			...
			return PairingUtils.isEqualElement(this.uv, that.getUv())
					&& Arrays.equals(this.byteArrayUv, that.byteArrayUv) && super.equals(anObject);
		}
		return false;
	}
