package cn.edu.ncepu.crypto.encryption.hibe.bb04.serparams;
...
public class HIBEBB04SecretKeySerParameter extends PairingKeySerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6787782462368677903L;
	...
	public HIBEBB04SecretKeySerParameter(PairingParameters pairingParameters, String[] ids, Element[] elementIds,
			Element d0, Element[] ds) {
