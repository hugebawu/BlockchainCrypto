...
public class HIBEBBG05DecryptionGenerator implements PairingDecryptionGenerator, PairingDecapsulationGenerator {
	...
	private void computeDecapsulation() throws InvalidCipherTextException {
		HIBEBBG05PublicKeySerParameter publicKeyParameters = (HIBEBBG05PublicKeySerParameter) this.params
				.getPublicKeyParameter();
		HIBEBBG05SecretKeySerParameter secretKeyParameters = (HIBEBBG05SecretKeySerParameter) this.params
				.getSecretKeyParameter();
		HIBEBBG05HeaderSerParameter ciphertextParameters = (HIBEBBG05HeaderSerParameter) this.params
	...
	public Element recoverMessage() throws InvalidCipherTextException {
		...
		HIBEBBG05CiphertextSerParameter ciphertextParameters = (HIBEBBG05CiphertextSerParameter) this.params
				.getCiphertextParameter();
