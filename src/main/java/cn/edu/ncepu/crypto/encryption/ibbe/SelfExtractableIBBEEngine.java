...
public class SelfExtractableIBBEEngine extends Engine {
	...
	public SelfExtractableIBBEEngine(IBBEEngine engine, PBEParametersGenerator pbeParametersGenerator,
	...
	public PairingKeyEncapsulationSerPair encapsulation(PairingKeySerParameter publicKey, String[] identitySet,
			byte[] ek) {
