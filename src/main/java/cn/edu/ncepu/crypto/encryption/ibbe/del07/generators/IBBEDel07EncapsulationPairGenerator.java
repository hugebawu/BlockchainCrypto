	...
	public PairingKeyEncapsulationSerPair generateEncryptionPair() {
		...
		if (ids.length > publicKeyParameters.getMaxBroadcastReceiver()) {
			throw new IllegalArgumentException(
					"# of broadcast receiver set " + ids.length + " is greater than the maximal number of receivers "
							+ publicKeyParameters.getMaxBroadcastReceiver());
		}
		...
		return new PairingKeyEncapsulationSerPair(byteArraySessionKey,
