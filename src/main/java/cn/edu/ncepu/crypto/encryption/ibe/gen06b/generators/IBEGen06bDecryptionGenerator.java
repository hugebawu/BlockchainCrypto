...
import cn.edu.ncepu.crypto.encryption.ibe.gen06b.serparams.IBEGen06bCiphertextSerParameter;
import cn.edu.ncepu.crypto.encryption.ibe.gen06b.serparams.IBEGen06bHeaderSerParameter;
...
public class IBEGen06bDecryptionGenerator implements PairingDecryptionGenerator, PairingDecapsulationGenerator {
	...
	public byte[] recoverKey() throws InvalidCipherTextException {
		IBEGen06bPublicKeySerParameter publicKeyParameter = (IBEGen06bPublicKeySerParameter) this.params
				.getPublicKeyParameter();
		IBEGen06bSecretKeySerParameter secretKeyParameter = (IBEGen06bSecretKeySerParameter) this.params
				.getSecretKeyParameter();
		IBEGen06bHeaderSerParameter ciphertextParameter = (IBEGen06bHeaderSerParameter) this.params
		...
		if (!ciphertextParameter.getY()
				.equals(pairing.pairing(u, secretKeyParameter.getHId2().mul(secretKeyParameter.getHId3().powZn(beta)))
	...
	public Element recoverMessage() throws InvalidCipherTextException {
		...
		IBEGen06bSecretKeySerParameter secretKeyParameter = (IBEGen06bSecretKeySerParameter) this.params
				.getSecretKeyParameter();
		IBEGen06bCiphertextSerParameter ciphertextParameter = (IBEGen06bCiphertextSerParameter) this.params
				.getCiphertextParameter();
		Pairing pairing = PairingFactory.getPairing(publicKeyParameter.getParameters());
		Element elementIdCT = PairingUtils.MapStringToGroup(pairing, this.params.getId(),
				PairingUtils.PairingGroupType.Zr);
		...
		Element sessionKey = pairing.pairing(u, secretKeyParameter.getHId()).mul(v.powZn(secretKeyParameter.getRId()))
				.getImmutable();
