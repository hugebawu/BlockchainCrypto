...
public class IBEGen06bCiphertextSerParameter extends IBEGen06bHeaderSerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4448018154744351128L;
	private transient Element w;
	private final byte[] byteArrayW;

	public IBEGen06bCiphertextSerParameter(PairingParameters pairingParameters, Element u, Element v, Element w,
			Element y) {
