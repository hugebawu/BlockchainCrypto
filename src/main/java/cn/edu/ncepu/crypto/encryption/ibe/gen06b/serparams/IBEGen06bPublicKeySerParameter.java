...
public class IBEGen06bPublicKeySerParameter extends IBEGen06aPublicKeySerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1924213202964066827L;
	...
	public IBEGen06bPublicKeySerParameter(PairingParameters pairingParameters, Element g, Element g1, Element h,
	...
	public boolean equals(Object anOjbect) {
		...
		if (anOjbect instanceof IBEGen06bPublicKeySerParameter) {
			...
			// Compare h3
			return PairingUtils.isEqualElement(this.h3, that.h3) && Arrays.equals(this.byteArrayH3, that.byteArrayH3)
