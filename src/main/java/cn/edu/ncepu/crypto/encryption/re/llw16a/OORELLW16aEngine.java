	...
	public PairingKeySerParameter keyGen(PairingKeySerParameter publicKey, PairingKeySerParameter masterKey,
		...
		if (!(publicKey instanceof RELLW16aPublicKeySerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, publicKey,
					RELLW16aPublicKeySerParameter.class.getName());
		}
		if (!(masterKey instanceof RELLW16aMasterSecretKeySerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, masterKey,
					RELLW16aMasterSecretKeySerParameter.class.getName());
		}
	...
	public Element decryption(PairingKeySerParameter publicKey, PairingKeySerParameter secretKey, String[] ids,
		...
		if (!(secretKey instanceof RELLW16aSecretKeySerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, secretKey,
					RELLW16aSecretKeySerParameter.class.getName());
		}
		if (!(ciphertext instanceof RELLW16aCiphertextSerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, ciphertext,
					RELLW16aCiphertextSerParameter.class.getName());
		}
		RELLW16aDecryptionGenerator decryptionGenerator = new RELLW16aDecryptionGenerator();
		decryptionGenerator.init(new REDecryptionGenerationParameter(publicKey, secretKey, ids, ciphertext));
	...
	public byte[] decapsulation(PairingKeySerParameter publicKey, PairingKeySerParameter secretKey, String[] ids,
		...
		if (!(header instanceof RELLW16aHeaderSerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, header,
					RELLW16aHeaderSerParameter.class.getName());
		}
		RELLW16aDecryptionGenerator decryptionGenerator = new RELLW16aDecryptionGenerator();
		decryptionGenerator.init(new REDecryptionGenerationParameter(publicKey, secretKey, ids, header));
	...
	public PairingKeyEncapsulationSerPair encapsulation(PairingKeySerParameter publicKey,
		...
		if (!(intermediate instanceof RELLW16aIntermediateSerParameter)) {
			PairingUtils.NotVerifyCipherParameterInstance(SCHEME_NAME, intermediate,
					RELLW16aIntermediateSerParameter.class.getName());
		}
		RELLW16aEncryptionGenerator encryptionGenerator = new RELLW16aEncryptionGenerator();
