...
public class RELLW16aDecryptionGenerator extends RELSW10aDecryptionGenerator {
	public void init(CipherParameters params) {
		...
		RELLW16aPublicKeySerParameter oriPublicKeyParameter = (RELLW16aPublicKeySerParameter) oriParameter
				.getPublicKeyParameter();
		RELLW16aHeaderSerParameter oriHeaderParameter = (RELLW16aHeaderSerParameter) oriParameter
		...
		for (String revokeId : oriC2s.keySet()) {
			Element newC2 = oriC2s.get(revokeId).mul(oriPublicKeyParameter.getGb2().powZn(oriC3s.get(revokeId)))
					.getImmutable();
		...
		if (oriHeaderParameter instanceof RELLW16aCiphertextSerParameter) {
			...
			REDecryptionGenerationParameter resultParameter = new REDecryptionGenerationParameter(
					oriParameter.getPublicKeyParameter(), oriParameter.getSecretKeyParameter(), oriParameter.getIds(),
	...
	public Element recoverMessage() throws InvalidCipherTextException {
		...
		RELLW16aCiphertextSerParameter ciphertextParameter = (RELLW16aCiphertextSerParameter) this.parameter
				.getCiphertextParameter();
