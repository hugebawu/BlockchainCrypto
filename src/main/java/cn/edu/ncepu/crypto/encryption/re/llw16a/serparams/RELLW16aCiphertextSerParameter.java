...
public class RELLW16aCiphertextSerParameter extends RELLW16aHeaderSerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1672722009559586522L;
	private transient Element C;
	private final byte[] byteArrayC;

	public RELLW16aCiphertextSerParameter(PairingParameters pairingParameters, Element C, Element C0,
