...
public class RELLW16aIntermediateSerParameter extends PairingCipherSerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8963396153781311367L;
	...
	public RELLW16aIntermediateSerParameter(PairingParameters parameters, int n, Element sessionKey, Element s,
			Element C0, Element[] ss, Element[] xs, Element[] C1s, Element[] C2s) {
		super(parameters);
		this.n = n;
