...
public class RELLW16bIntermediateGenerator extends RELLW16aIntermediateGenerator {
	...
	public PairingCipherSerParameter generateCiphertext() {
		...
		return new RELLW16bIntermediateSerParameter(publicKeyParameter.getParameters(), this.n, chameleonHash, r,
				chameleonHashPublicKey, chameleonHashSecretKey, C01, C02, sessionKey, s, C0, ss, xs, C1s, C2s);
	}
}
