...
public class RELLW16bKeyPairGenerator extends RELLW16aKeyPairGenerator {
	public PairingKeySerPair generateKeyPair() {
		...
		RELLW16aPublicKeySerParameter oriPublicKeyParameter = (RELLW16aPublicKeySerParameter) pairingKeySerPair
				.getPublic();
		RELLW16aMasterSecretKeySerParameter oriMasterKeyParameter = (RELLW16aMasterSecretKeySerParameter) pairingKeySerPair
				.getPrivate();
		...
		RELLW16bMasterSecretKeySerParameter masterKeyParameter = new RELLW16bMasterSecretKeySerParameter(
				oriMasterKeyParameter.getParameters(), oriMasterKeyParameter.getAlpha(), oriMasterKeyParameter.getB(),
