...
public class RELLW16bIntermediateSerParameter extends RELLW16aIntermediateSerParameter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1410964964050321273L;
	...
	public RELLW16bIntermediateSerParameter(PairingParameters parameters, int n, byte[] chameleonHash, byte[] r,
			AsymmetricKeySerParameter chameleonHashPublicKey, AsymmetricKeySerParameter chameleonHashSecretKey,
			Element C01, Element C02, Element sessionKey, Element s, Element C0, Element[] ss, Element[] xs,
