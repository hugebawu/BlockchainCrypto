...
public class PolicyParserJUnitTest extends TestCase {
	...
	private static final String[] access_policy_exampe_1_satisfied_1 = new String[] { "school:pku", "professor",
			"academy:software" };
	private static final String[] access_policy_exampe_1_satisfied_2 = new String[] { "school:pku", "professor",
			"academy:software", "academy:computer" };
	private static final String[] access_policy_exampe_1_unsatisfied_1 = new String[] { "professor", "academy:software",
			"academy:computer" };

	private static final String access_policy_example_2 = "(school:pku and academy:software) or (school:mit and academy:computer)";
	private static final String[] access_policy_exampe_2_satisfied_1 = new String[] { "school:pku",
			"academy:software" };
	private static final String[] access_policy_exampe_2_satisfied_2 = new String[] { "school:pku", "school:mit",
			"academy:computer" };
	private static final String[] access_policy_exampe_2_unsatisfied_1 = new String[] { "school:pku" };
	private static final String[] access_policy_exampe_2_unsatisfied_2 = new String[] { "school:pku",
			"academy:computer" };

	private static final String access_policy_example_3 = "A_00 and A_01 and A_02 and A_03 and A_04 and A_05 and A_06 and A_07 and A_08 and A_09 and "
	...
	private static final String[] access_policy_exampe_3_satisfied_1 = new String[] { "A_00", "A_01", "A_02", "A_03",
			"A_04", "A_05", "A_06", "A_07", "A_08", "A_09", "A_10", "A_11", "A_12", "A_13", "A_14", "A_15", "A_16",
			"A_17", "A_18", "A_19", "A_20", "A_21", "A_22", "A_23", "A_24", "A_25", "A_26", "A_27", "A_28", "A_29",
			"A_30", "A_31", "A_32", "A_33", "A_34", "A_35", "A_36", "A_37", "A_38", "A_39", "A_40", "A_41", "A_42",
			"A_43", "A_44", "A_45", "A_46", "A_47", "A_48", "A_49", };
	private static final String[] access_policy_exampe_3_unsatisfied_1 = new String[] { "A_00", "A_01", "A_02", "A_03",
			"A_04", "A_05", "A_06", "A_07", "A_08", "A_09", "A_10", "A_11", "A_12", "A_13", "A_14", "A_15", "A_16",
			"A_17", "A_18", "A_19", "A_20", "A_21", "A_22", "A_23", "A_24", "A_25", "A_26", "A_27", "A_28", "A_29",
			"A_30", "A_31", "A_32", "A_33", "A_34", "A_35", "A_36", "A_37", "A_38", "A_39", "A_40", "A_41", "A_42",
			"A_43", "A_44", "A_45", "A_46", "A_47", "A_48", };
	private static final String[] access_policy_exampe_3_unsatisfied_2 = new String[] { "A_04", "A_05", "A_06", "A_07",
			"A_08", "A_09", "A_10", "A_11", "A_12", "A_13", "A_14", "A_15", "A_16", "A_17", "A_18", "A_19", "A_20",
			"A_21", "A_22", "A_23", "A_24", "A_25", "A_26", "A_27", "A_28", "A_29", "A_30", "A_31", "A_32", "A_33",
			"A_34", "A_37", "A_38", "A_39", "A_40", "A_41", "A_42", "A_43", "A_44", "A_45", "A_46", "A_47", "A_48",
			"A_49", };

	private LSSSPolicyEngine lsssPolicyEngine;

	private void try_valid_access_policy(Pairing pairing, int testIndex, String accessPolicyString,
...
//        logger.info("Generated Secret s = " + secret);
			Map<String, Element> lambdaElementsMap = lsssPolicyEngine.secretSharing(pairing, secret,
					accessControlParameter);
			// Secret Reconstruction
			Map<String, Element> omegaElementsMap = lsssPolicyEngine.reconstructOmegas(pairing, attributeSet,
					accessControlParameter);
...
//                System.exit(0);
	...
	private void try_invalid_access_policy(Pairing pairing, int testIndex, String accessPolicyString,
			final String[] attributeSet) {
		try {
			int[][] accessPolicy = ParserUtils.GenerateAccessPolicy(accessPolicyString);
			String[] rhos = ParserUtils.GenerateRhos(accessPolicyString);
